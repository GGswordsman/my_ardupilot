...
void AP_Baro::update(void)
{
    ...
    // 如果当前高度偏移和激活的高度偏移差异超过1厘米，则通过低通滤波器慢慢调整，以避免对EKF产生冲击
