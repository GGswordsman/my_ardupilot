...
/*
硬件板卡信息库,还具有其他类型的硬件平台的变体，例如 AVR 基础、 Linux 基础等
包含读取无线、写入电机、处理数字和模拟端口、串行通信、实时操作调度程序、将数据包写入 SD 存储器等所有命令
*/
#include <AP_HAL/AP_HAL.h>
//常用函数库，例如用于串行通信的高低部件转换器，角度测量系统之间的转换（弧度到角度）等
#include <AP_Common/AP_Common.h>
#include <AP_Airspeed/AP_Airspeed.h>
//它包含用于在不同类型的变量之间进行转换和交互的函数
#include <AP_Param/AP_Param.h>
#include <StorageManager/StorageManager.h>
//ArduPilot 向量/矩阵数学库  它包含用于矩阵和矢量运算、归一化、单位类型转换等专门的数学函数
...
#include <AP_Declination/AP_Declination.h> // ArduPilot Mega Declination Helper Library 磁偏角助手库
#include <AP_Logger/AP_Logger.h>
#include <AP_Scheduler/AP_Scheduler.h>       // main loop scheduler
#include <AP_Scheduler/PerfInfo.h>                  // loop perf monitoring 循环性能监控
...
#include <AP_Mission/AP_Mission.h>     // Mission command library 任务命令库
